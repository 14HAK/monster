<img src="./_assets/monster.png" alt="isolated" width="full" style="margin: 0 auto;"/>
...
# Packages [yarn environment demo]:

`````javascript
FIRST REMOVE TOP TO BOTTOM COMMENT. MAIN FILE IS README.MD FILE. CHECK THIS FILE FOR REAL VIBE
// //demo badge:
// https://gist.github.com/daltonbr/7b642dfff171e78e46865e7b65973579
...
// //direct method to using svg icons:
// <a href="https://github.com/" target="_blank"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="40px" width="40px" xmlns="http://www.w3.org/2000/svg"><path d="M418.2 177.2c-5.4-1.8-10.8-3.5-16.2-5.1.9-3.7 1.7-7.4 2.5-11.1 12.3-59.6 4.2-107.5-23.1-123.3-26.3-15.1-69.2.6-112.6 "></path></svg></a>

// //raw examples readme.md:
// # Badges - using shields.io

// More details in the YouTube Video.
// [![Watch the video](https://img.youtube.com/vi/xaktHJ8EPk0/maxresdefault.jpg)](https://www.youtube.com/watch?v=xaktHJ8EPk0)
